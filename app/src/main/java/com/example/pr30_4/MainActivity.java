...
public class MainActivity extends Activity {
    ...
    public void onClickStart(View v) {
        ...
        Intent taskIntent1 = new Intent();
        pi = createPendingResult(TASK1_CODE, taskIntent1, 0);
        ...
        Intent taskIntent2 = new Intent();
        pi = createPendingResult(TASK2_CODE, taskIntent2, 0);
        intent = new Intent(this, MyService.class).putExtra(PARAM_TIME, 4)
                .putExtra(PARAM_PINTENT, pi);
        startService(intent);

        Intent taskIntent3 = new Intent();
        pi = createPendingResult(TASK3_CODE, taskIntent3, 0);
